          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                ...
                <p className={`text-xs ${textSecondary}`}>Admin Dashboard</p>
              </div>
            </div>
          ...
          {user && (
            <div className={`p-4 rounded-xl ${darkMode ? 'bg-white/5' : 'bg-gray-50'}`}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <p className={`text-xs ${textSecondary} mb-1`}>Role</p>
                  <p className={`font-semibold ${textPrimary}`}>{user.role || 'admin'}</p>
                </div>
              </div>
            </div>
          )}
